const flats = [{
  ...
  console.group('1. Patikrinkite, ar yra butų, su daugiau nei 5 kambariais');
  {
    ...
    const isThereFlatWithMoreThen5Rooms = flats.some(({rooms})=>rooms.length>5);
    console.log(isThereFlatWithMoreThen5Rooms);
  }
  console.groupEnd();
  ...
  console.group('2. Patikrinkite, ar visi butai brangesni už 50 000');
  {
    ...
    const isAllFlatsForMoreThen50k = flats.every(({price})=>price>50000);
    console.log(isAllFlatsForMoreThen50k);
  }
  console.groupEnd();
  ...
  console.group('3. Suraskite pirmą butą, kuris pigesnis už 55 000 ir jį atspausdinkite');
  {
    ...
    const flatCheaperThen55k = flats.find(flat=>flat.price < 55000);
    console.log(flatCheaperThen55k);
  }
  console.groupEnd();
  ...
  const firstFlatCheaperThen90k = flats.findIndex(flat=>flat.price > 90000);
  flats.splice(firstFlatCheaperThen90k+1, 0, flatToAdd);
  console.log(flats);
